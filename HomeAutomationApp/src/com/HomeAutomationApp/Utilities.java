...
public class Utilities {
  ...
  private static final String MY_ACTIVITY = "H_AUTO";
  ...
  public static Animation inFromRightAnimation(float param) {
    ...
    Animation inFromRight = new TranslateAnimation(
        Animation.RELATIVE_TO_PARENT, +param, Animation.RELATIVE_TO_PARENT,
  ...
  public static Animation inFromLeftAnimation(float param) {
    Animation inFromLeft = new TranslateAnimation(Animation.RELATIVE_TO_PARENT,
        -param, Animation.RELATIVE_TO_PARENT, 0.0f,
  ...
  public static Animation outToLeftAnimation(float param) {
    Animation outtoLeft = new TranslateAnimation(Animation.RELATIVE_TO_PARENT,
        0.0f, Animation.RELATIVE_TO_PARENT, -param,
        Animation.RELATIVE_TO_PARENT, 0.0f, Animation.RELATIVE_TO_PARENT, 0.0f);
